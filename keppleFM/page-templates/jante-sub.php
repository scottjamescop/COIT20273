			...
			<div class="janteHero">
				<div class="row" style="width:1170px !important; max-width: none !important;">
					<div class="small-6 columns posRel">
						<a href="http://www.mileswebservices.com/jante/"><img src="http://www.mileswebservices.com/wp-content/uploads/2019/07/jante_logo_white.png" style="max-height: 70px; margin-top: 20px;" /></a>
					</div>
...
<div class="row searchResultsWrapper PadT20 PadB40">
	<div class="small-12 columns text-center">
		<h2>Search Results</h2>
	</div>
	<div class="small-6 medium-4 columns end">
		<div class="searchCard">
			<img src="http://www.mileswebservices.com/wp-content/uploads/2019/07/rim.jpg" />
			<div class="contentBox">
				<p><b>High Quality Wheel Product</b></p>
				<p>Spec: Detail<br />Spec: Detail<br />Spec: Detail</p>
				<p><b>$159.99</b></p>
			</div>
		</div>
	</div>
	...
	<div class="bottomBar">
		<div class="row spec">
			<div class="small-12 columns">
				Copyright 2016 © Jante Wheel, Inc. | An Image1 Tech Development.
			</div>
		</div>
	</div>
</footer>
